...
public class Constants {
	...
	public static int XBOX_DRIVE_Z_AXIS = 3;
	...
	public static int PILOT_SHIFT_UP_BUTTON = 0;
	public static int PILOT_SHIFT_DOWN_BUTTON = 1;
	...
	public static int PILOT_GEARINTAKE_TOGGLE_BUTTON = 4;
